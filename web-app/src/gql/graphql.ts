...
export type GetMyProfileHeaderQuery = { __typename?: 'Query', myProfile: { __typename?: 'User', email: string, id: string, initials: string } };
...
export type GetMyProfileSignInQuery = { __typename?: 'Query', myProfile: { __typename?: 'User', email: string, id: string, firstName: string, lastName: string } };
