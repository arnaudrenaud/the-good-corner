...
export class Migration1721806335450 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "TagsForAds" ("adId" uuid NOT NULL, "tagId" uuid NOT NULL, CONSTRAINT "PK_f17c6839bd4709726b907fefa16" PRIMARY KEY ("adId", "tagId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_256f37a80f68bcda8094748c4b" ON "TagsForAds" ("adId") `);
        await queryRunner.query(`CREATE INDEX "IDX_70d1b1e53059e5deaad2f3fe4e" ON "TagsForAds" ("tagId") `);
        ...
        await queryRunner.query(`ALTER TABLE "ad" ADD CONSTRAINT "FK_60e59329bce691e9d31a3e3131b" FOREIGN KEY ("ownerId") REFERENCES "AppUser"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "TagsForAds" ADD CONSTRAINT "FK_256f37a80f68bcda8094748c4b3" FOREIGN KEY ("adId") REFERENCES "ad"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "TagsForAds" ADD CONSTRAINT "FK_70d1b1e53059e5deaad2f3fe4eb" FOREIGN KEY ("tagId") REFERENCES "tag"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "TagsForAds" DROP CONSTRAINT "FK_70d1b1e53059e5deaad2f3fe4eb"`);
        await queryRunner.query(`ALTER TABLE "TagsForAds" DROP CONSTRAINT "FK_256f37a80f68bcda8094748c4b3"`);
        await queryRunner.query(`ALTER TABLE "ad" DROP CONSTRAINT "FK_c418809c6e081f861cefe495668"`);
        await queryRunner.query(`ALTER TABLE "ad" DROP CONSTRAINT "FK_60e59329bce691e9d31a3e3131b"`);
        await queryRunner.query(`ALTER TABLE "user_session" DROP CONSTRAINT "FK_b5eb7aa08382591e7c2d1244fe5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_70d1b1e53059e5deaad2f3fe4e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_256f37a80f68bcda8094748c4b"`);
